							...
							<div class="col-lg-12">
								<form id="login-form" action="login.php" method="post" role="form" style="display: block;">
									<div class="form-group">
										<input type="text" name="uid" id="uid" tabindex="1" class="form-control" placeholder="UID" value="">
									</div>
									<div class="form-group">
								...
								<form id="register-form" action="signup.php" method="POST" role="form" style="display: none;">
									...
									<div class="form-group">
										<input type="text" name="uid" id="confirm-password" tabindex="2" class="form-control" placeholder="Enter UID">
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
